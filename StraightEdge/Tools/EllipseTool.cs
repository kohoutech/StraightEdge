...
namespace StraightEdge.Tools
{
    class EllipseTool : SETool
    {
            ...
            : base(window)
        {
            if (!registered)
            {
                SEIllustration.registerShapeTool("ellipse", this);
                registered = true;
            }
        ...
        public override void loadShape(XmlNode shapeNode, SEIllustration illo)
        {
            ...
            currentEllipse = new SEEllipse(canvas.currentIllo.shapes.Count, orgX, orgY);
...
//- mouse handling ------------------------------------------------------------
        ...
        public override void mouseDown(MouseEventArgs e)
        {
            ...
            currentEllipse.tool = this;
            canvas.currentIllo.shapes.Add(currentEllipse);
        }
