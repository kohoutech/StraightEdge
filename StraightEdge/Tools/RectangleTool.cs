...
namespace StraightEdge.Tools
{
    public class RectangleTool : SETool
    {
            ...
            : base(window)        
        {
            if (!registered)
            {
                SEIllustration.registerShapeTool("rectangle", this);
                registered = true;
            }
        ...
        public override void loadShape(XmlNode shapeNode, SEIllustration illo)
        {
            ...
            currentRect = new SERectangle(canvas.currentIllo.shapes.Count, orgX, orgY);
            currentRect.id = id;
...
//- mouse handling ------------------------------------------------------------
        ...
        public override void mouseDown(MouseEventArgs e)
        {
            ...
            currentRect.tool = this;
            canvas.currentIllo.shapes.Add(currentRect);
        }
